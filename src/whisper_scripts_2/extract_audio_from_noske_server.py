...
# Main directories
main_dirs = ['E:/Code/eptic/data/raw/noske_videos/video_audios/english',
             'E:/Code/eptic/data/raw/noske_videos/video_audios/french',
             'E:/Code/eptic/data/raw/noske_videos/video_audios/italian',
             'E:/Code/eptic/data/raw/noske_videos/video_audios/slovenian']
            ...
            for file in os.listdir(subfolder_path):
                if file.endswith('.xlsx'):
                    ...
                    for index, row in df.iterrows():
                        ...
                        if video_url:
                            audio_filename = f"{row['text.id']}_{row['s.id']}_{row['subset']}.mp3"
